...
if image is None:
    logging.error('Image not found. Please check the filename and try again.')
else:
    ...
    if ret == True:
        logging.info('Chessboard found. Drawing the corners...')
        ...
        logging.info('No chessboard could be found in the image.')
